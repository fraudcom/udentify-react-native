...
export interface Spec extends TurboModule {
   ...
   * setMicrophoneEnabled() - it is explicit rather than relative to a state
   * the SDK changes on its own, and works on both platforms. Rejects with
   * ERR_NOT_SUPPORTED on Android.
   */

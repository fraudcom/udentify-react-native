...
// TurboModule Spec interface - similar to OCR library
export interface VideoCallConfig_TurboModule {
  // Basic config
  ...
  allowMicrophoneToggle?: boolean;
  showParticipantList?: boolean;
}

// Specific interface for credentials to avoid 'any' type
export interface VideoCallCredentials_TurboModule {
  serverURL: string;
...
// Specific interface for result to avoid 'any' type  
export interface VideoCallResult_TurboModule {
  success: boolean;
  message?: string;
  errorType?: string;
}
...
export interface Spec extends TurboModule {
  ...
  startVideoCall(credentials: VideoCallCredentials_TurboModule): Promise<VideoCallResult_TurboModule>;
  endVideoCall(): Promise<VideoCallResult_TurboModule>;
  getVideoCallStatus(): Promise<string>;

  // Configuration methods
  setVideoCallConfig(config: VideoCallConfig_TurboModule): Promise<void>;

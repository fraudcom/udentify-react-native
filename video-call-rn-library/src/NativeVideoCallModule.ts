...
export class NativeVideoCallModule {
  ...
  static async configureUISettings(uiConfig: VideoCallConfig): Promise<boolean> {
    try {
      ...
      console.warn('VideoCallModule - configureUISettings error:', error);
      throw error;
    }
  }
  ...
  static async setVideoCallConfig(config: VideoCallConfig): Promise<void> {
    try {
      ...
      console.warn('VideoCall - Error setting video call config:', error);
  ...
  static async toggleCamera(): Promise<boolean> {
    try {
      ...
      console.warn('VideoCall - Error toggling camera:', error);
      return false;
    }
  }
  ...
  static async switchCamera(): Promise<boolean> {
    try {
      ...
      console.warn('VideoCall - Error switching camera:', error);
      return false;
    }
  }

...
class VideoCallModule(reactContext: ReactApplicationContext) :
    ...
    fun startVideoCall(credentials: ReadableMap, promise: Promise) {
        try {
            ...
            if (activity == null) {
                promise.reject("NO_ACTIVITY", reactApplicationContext.getString(R.string.vc_error_no_fragment_activity), null)
                return
            }
            ...
            if (serverURL == null || wssURL == null || userID == null || 
                ...
                promise.reject("MISSING_PARAMETERS", reactApplicationContext.getString(R.string.vc_error_missing_parameters), null)
                return
            }

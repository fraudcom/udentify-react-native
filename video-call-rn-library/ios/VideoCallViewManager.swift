...
/// INTERNALS.md "iOS screen-lock reference counting (VideoCallScreenLock)".
...
/// points without editing vendor source, so each vendor SDK drop can be
/// applied to `ios/Frameworks/UdentifyVC` with as small a delta as possible.

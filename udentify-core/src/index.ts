...
// Literals by design - do not replace with a require() of package.json.
// Keep in sync by hand with package.json and android/libs/.
export const version = '26.3.923';

export const frameworks = {
  ios: ['UdentifyCommons.xcframework'],
  android: ['commons-26.3.0923.aar']
};

 ...
 */
export function addNFCProgressListener(
  callback: (event: NFCProgressEvent) => void
): EmitterSubscription {
  return DeviceEventEmitter.addListener('onNFCProgress', callback);
}

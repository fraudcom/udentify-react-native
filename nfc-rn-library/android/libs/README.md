...
- `commons-25.4.0.aar` - Udentify Commons library (shared with OCR)
- `nfc-25.4.0.aar` - Udentify NFC library
...
2. The `build.gradle` file is already configured to include them:
   ```gradle
   api files('libs/commons-25.4.0.aar')
   api files('libs/nfc-25.4.0.aar')
   ```
...
**Commons Library**: `commons-25.4.0.aar` - ✅ Available
**NFC Library**: `nfc-25.4.0.aar` - ✅ Available

...
RCT_EXPORT_METHOD(estimateDemographics:(NSString *)serverURL
                  transactionID:(NSString *)transactionID
                  imageBase64:(NSString *)imageBase64
                  resolver:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject)
{
    [self.livenessManager estimateDemographics:serverURL transactionID:transactionID imageBase64:imageBase64 resolver:resolve rejecter:reject];
}

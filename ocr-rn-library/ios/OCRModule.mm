...
// Note: Event emitter functionality removed for simplicity
// React Native will call startOCRScanning, then performOCR with empty strings
// to use the captured images from the document scan

...
video-call-rn-library-26.3.921.tgz   # Frameworks/UdentifyVC (Swift sources) + LiveKitClient
```
...
npm install ./video-call-rn-library-26.3.921.tgz # For agent-assisted video call
```
...
- **Current Version**: 26.3.814 (`video-call-rn-library` is ahead at `26.3.921` — see its own Version History entry below)
- **Distribution**: 6 TGZ packages (1 core + 5 feature libraries)
- **Compatibility**: React Native 0.73.0+ (libraries), 0.76.0+ (test-app)
- **Native SDK Version**: Udentify SDK 26.3.0814 (`video-call-rn-library`: iOS 26.3.0917, Android 26.3.0921)
...
### `video-call-rn-library` 26.3.921 (Current for this package — Native SDK iOS 26.3.0917 / Android 26.3.0921)

...
video-call-rn-library-26.3.916.tgz   # Frameworks/UdentifyVC (vendored Swift source) + LiveKitClient
```
...
npm install ./video-call-rn-library-26.3.916.tgz # For agent-assisted video call
```
...
- **Current Version**: 26.3.814 (`video-call-rn-library` is ahead at `26.3.916` — see its own Version History entry below)
...
### `video-call-rn-library` 26.3.916 (Current for this package — Native SDK iOS 26.3.0914 / Android 26.3.0916)

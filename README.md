...
video-call-rn-library-26.3.917.tgz   # Frameworks/UdentifyVC (vendored Swift source) + LiveKitClient
```
...
└── video-call-rn-library
    ├── Frameworks/UdentifyVC (vendored Swift source, not an .xcframework)
...
### `video-call-rn-library` 26.3.917 (Current for this package — Native SDK iOS 26.3.0914 / Android 26.3.0916)
iOS session-lifetime fix; no native SDK change and no JS-facing API change.

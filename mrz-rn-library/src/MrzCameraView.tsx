...
// Type-only, so imported as such: this package ships its raw `src` as its type
// entry point, and a consumer compiling with `verbatimModuleSyntax` rejects a
// value import of a type (TS1484).
